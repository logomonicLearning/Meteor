...
//     var errEnquiry, errModel, errFName, errLName, errEmail, errPhone, errConsent, errDescription
    document.getElementById("err-enquiry").innerHTML=errEnquiry
    document.getElementById("err-model").innerHTML=errModel
    document.getElementById("err-description").innerHTML=errDescription
      document.getElementById("err-fname").innerHTML=errFName
      document.getElementById("err-lname").innerHTML=errLName
      document.getElementById("err-email").innerHTML=errEmail
      document.getElementById("err-phone").innerHTML=errPhone
      document.getElementById("err-consent").innerHTML=errConsent
